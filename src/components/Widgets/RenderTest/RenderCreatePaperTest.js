...
import qstyles from './CreateExamPaper.css';
...
class RenderCreatePaperTest extends React.Component {
  ...
  randerTestQuestion = (data, type, index) => {
    ...
    // let typeStr = (<span className={styles.questionRadio1}>多选</span>);
                ...
                </div>
                {
                  repeatQuestionsList.length > 1 ?
                    <span style={{ float: 'right' }}>
                      ...
                      >
                        <Icon type="exclamation-circle" className={qstyles.createPaperTipsIcon} />
                      </Popover>
                    </span> : ''
                }
              </div>
