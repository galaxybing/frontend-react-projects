...
export type Action =
    { type: 'LOADED_CONFIG_DATA' }
  | { type: 'LOAD_SITE_INDEX', list: Arrsay<ParseObject> }
  | { type: 'LOAD_SITE_INDEX_MORE', list: Arrsay<ParseObject> }
  | { type: 'LOAD_SITE_COLUMN', list: Arrsay<ParseObject> }
  | { type: 'GET_ARTICEL_INFO', list: Arrsay<ParseObject> }

  | { type: 'LOADED_ABOUT', list: Arrsay<ParseObject> }
